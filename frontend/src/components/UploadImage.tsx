...
function UploadImage() {
  ...
  return (
    <div className="space-y-20 lg:flex lg:space-x-[5%]">
      ...
      <div className="space-y-5 md:flex md:space-y-0 md:space-x-10 lg:flex-col lg:space-y-5">
        <div className="bg-primary-gradient-reverse rounded-lg h-52 w-full p-0.5 outline-5 -outline-offset-3 outline-dashed outline-primary-bg md:basis-2/3 lg:basis-auto">
        ...
        <div className="flex flex-col justify-between space-y-2 md:basis-1/3 lg:basis-auto">
